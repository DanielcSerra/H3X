  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      ...
      <form method="POST" action="">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nome" name="nome" placeholder="Escreve o teu nome" value="<?= htmlspecialchars($nome ?? '') ?>" required>
        </div>

        <div class="mb-3">
          <label for="assunto" class="form-label">Assunto</label>
          <input type="text" class="form-control" id="assunto" name="assunto" placeholder="Teu número de telefone" value="<?= htmlspecialchars($assunto ?? '') ?>" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="Teu número de telefone" value="<?= htmlspecialchars($telefone ?? '') ?>" required>
        </div>

        <div class="mb-3">
          <label for="mensagem" class="form-label">Mensagem</label>
          <textarea class="form-control" id="mensagem" name="mensagem" rows="4" placeholder="Escreve a tua mensagem" required><?= htmlspecialchars($mensagem ?? '') ?></textarea>
        </div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3068.228507335417!2d-8.825259736107782!3d39.73451765260679!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd22735a4e067afb%3A0xcfaf619f4450fa76!2sPolit%C3%A9cnico%20de%20Leiria%20%7C%20ESTG%20-%20Escola%20Superior%20de%20Tecnologia%20e%20Gest%C3%A3o_Edif%C3%ADcio%20D!5e0!3m2!1spt-PT!2spt!4v1748532881324!5m2!1spt-PT!2spt" height="450" style="border:0; width:100%; filter: invert(90%)" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
