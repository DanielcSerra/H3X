    ...
    <div class="d-flex">
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="table-title m-0">Serviços VIP</h1>
                <div>
                    <a href="admin_servicos_vip_create.php" class="btn btn-success shadow-sm px-4 py-2 fw-semibold">
                        <i class="fas fa-plus me-2"></i> Adicionar Serviço VIP
                    </a>
                </div>
            </div>
            ...
            <?php
            $sql = "SELECT id, titulo, imagem FROM servicos_vip ORDER BY id DESC";
