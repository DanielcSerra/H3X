                    ...
                    <form method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-sm w-100"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nome" id="nome"
                                value="<?= trim($utilizador["nome"]) ?>" required pattern="^[A-Za-zÀ-ÿ\s]{2,15}$"
                                title="Nome deve conter apenas letras, com pelo menos 2 caracteres.">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" name="telefone" id="telefone"
                                value="<?= trim($utilizador["telefone"]) ?>" pattern="[0-9]{9}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="tipo" id="tipo" required>
                                ...
                                <option value="f" <?= $utilizador["tipo"] == "f" ? "selected" : "" ?>>Funcionário</option>
                        ...
                        <?php if (!empty($utilizador["foto"])): ?>
                            <div class="mb-3">
                                ...
                                <img src="../uploads/<?= htmlspecialchars($utilizador["foto"]) ?>" alt="Foto de perfil"
