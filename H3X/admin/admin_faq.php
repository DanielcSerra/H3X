                    ...
                    <?php while ($faq = $result->fetch_object()):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="respostaModal<?= $id ?>" tabindex="-1" aria-labelledby="respostaModalLabel<?= $id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="respostaModalLabel<?= $id ?>">Resposta - <?= $titulo ?></h5>
                            ...
                            <td>
                                <a href="admin_faq_edit.php?id=<?= urlencode($id) ?>" title="Editar"><i class="fas fa-pen-to-square text-warning"></i></a>
                                <a href="admin_faq_delete.php?id=<?= urlencode($id) ?>" title="Apagar" class="ms-2"><i class="fas fa-trash text-danger"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
