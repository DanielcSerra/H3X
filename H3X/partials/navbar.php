...
<nav class="navbar fixed-top">
  ...
  <div class="menu-container">
    ...
    <?php else: ?>
      <div class="dropdown">
        <a class="login-btn dropdown-toggle d-flex align-items-center text-decoration-none" href="#" role="button"
          data-bs-toggle="dropdown" aria-expanded="false">
          <?php
          if (!empty($_SESSION['foto'])) {
            echo '<img src="uploads/' . trim($_SESSION['foto']) . '" alt="Foto" style="width: 32px; height: 32px; object-fit: cover; border-radius: 50%; margin-right: 8px;">';
          } else {
        ...
        <ul class="dropdown-menu custom-dropdown dropdown-menu-end shadow border-0">
          ...
          <?php if (in_array($_SESSION['tipo'], ['a', 'f'])): ?>
            <li><a class="dropdown-item" href="admin/admin_dashboard.php"><i
                  class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
          <?php endif; ?>
          <li>
            <hr class="dropdown-divider">
          </li>
          <li><a class="dropdown-item logout-item" href="admin/logout.php"><i
...
<div class="fullscreen-menu" id="fullscreenMenu">
  <div class="fullscreen-box" id="fullscreenbox">
    ...
    <a href="contactos.php" class="<?= $fileName == 'contatos.php' ? 'sel_nav' : '' ?>">CONTACTOS</a>
  </div>
</div>